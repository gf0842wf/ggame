...
support reconnect
default autocommit=True (Transction is not recommended)
default cursorclass=DictCursor
***mysql版本必须大于5.1, 否则无法使用 事务(autocommit),5.6版本中autocommit测试通过***
...
class Connection(object):
    ...
    def __init__(self, host, user, passwd, db, port=3306, autocommit=True, charset='utf8'):
        ...
        logger.debug('ultramysql params: %s', self.args)
...
if __name__ == '__main__':
    ...
    pool.execute("insert into book set name='bcd', author='fk'", block=False)
